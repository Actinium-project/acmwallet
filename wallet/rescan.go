...
type RescanJob struct {
	...
	OutPoints   map[wire.OutPoint]acmutil.Address
...
// rescan.
func (w *Wallet) Rescan(addrs []acmutil.Address, unspent []wtxmgr.Credit) error {
...
func (w *Wallet) rescanWithTarget(addrs []acmutil.Address,
	unspent []wtxmgr.Credit, startStamp *waddrmgr.BlockStamp) error {

	outpoints := make(map[wire.OutPoint]acmutil.Address, len(unspent))
