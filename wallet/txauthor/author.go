...
import (
	...
	"github.com/Actinium-project/acmwallet/wallet/txsizes"
)

// SumOutputValues sums up the list of TxOuts and returns an Amount.
func SumOutputValues(outputs []*wire.TxOut) (totalOutput acmutil.Amount) {
	for _, txOut := range outputs {
		totalOutput += acmutil.Amount(txOut.Value)
	}
	return totalOutput
}
...
// InputSourceError.
type InputSource func(target acmutil.Amount) (total acmutil.Amount, inputs []*wire.TxIn,
...
type AuthoredTx struct {
	Tx              *wire.MsgTx
	PrevScripts     [][]byte
	PrevInputValues []acmutil.Amount
	TotalInput      acmutil.Amount
...
func NewUnsignedTransaction(outputs []*wire.TxOut, relayFeePerKb acmutil.Amount,
...
func AddAllInputScripts(tx *wire.MsgTx, prevPkScripts [][]byte, inputValues []acmutil.Amount,
...
func spendWitnessKeyHash(txIn *wire.TxIn, pkScript []byte,
	...
	p2wkhAddr, err := acmutil.NewAddressWitnessPubKeyHash(pubKeyHash, chainParams)
	if err != nil {
		return err
	}
