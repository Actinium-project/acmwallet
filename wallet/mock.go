...
func (m *mockChainClient) Rescan(*chainhash.Hash, []acmutil.Address,
	map[wire.OutPoint]acmutil.Address) error {
	return nil
}

func (m *mockChainClient) NotifyReceived([]acmutil.Address) error {
	return nil
}
