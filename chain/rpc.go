...
func (c *RPCClient) Rescan(startHash *chainhash.Hash, addrs []acmutil.Address,
...
func parseBlock(block *acmjson.BlockDetails) (*wtxmgr.BlockMeta, error) {
	if block == nil {
		return nil, nil
	}
...
func (c *RPCClient) onRecvTx(tx *acmutil.Tx, block *acmjson.BlockDetails) {
...
func (c *RPCClient) onRedeemingTx(tx *acmutil.Tx, block *acmjson.BlockDetails) {
