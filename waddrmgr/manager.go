...
func (m *Manager) MarkUsed(ns walletdb.ReadWriteBucket, address acmutil.Address) error {
	m.mtx.RLock()
	defer m.mtx.RUnlock()
...
func (m *Manager) AddrAccount(ns walletdb.ReadBucket,
	address acmutil.Address) (*ScopedKeyManager, uint32, error) {
...
func (m *Manager) ForEachActiveAddress(ns walletdb.ReadBucket, fn func(addr acmutil.Address) error) error {
	m.mtx.RLock()
	defer m.mtx.RUnlock()
